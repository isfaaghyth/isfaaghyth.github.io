...
> To see a real world example of this setup (using full stack TypeScript), look at [the source of TakeNote](https://github.com/isfaaghyth/takenote).
...
The [Webpack Boilerplate](https://github.com/isfaaghyth/webpack-boilerplate) is a good example to use for how to set up Webpack (in this case, you would just move everything from building directly to `src` to building to `src/client`).
