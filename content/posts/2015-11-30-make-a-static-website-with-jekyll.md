...
- [View Demo](http://isfaaghyth.github.io/startjekyll/) 
- [View on GitHub](http://github.com/isfaaghyth/startjekyll/)
...
If you don't have a basic knowledge of command lines and Git, please read [the getting started with Git](http://www.isfaa.js.org/getting-started-with-git/) article. This will cover everything you need to know to get started with using Git and the command line.
...
```terminal
New jekyll site installed in /Users/isfaaghyth/Sites/startjekyll.
```
...
```terminal
Initialized empty Git repository in /Users/isfaaghyth/Sites/startjekyll/.git/
```
...
> I'm going to go through all the files from here on out. If you'd rather clone the Git repository, you can [view it here](https://github.com/isfaaghyth/startjekyll). All the files in the repo will be the same as what I display here.
...
# Site Settings
title: Start Jekyll
email: isfaaghyth@gmail.com
description: >
  A guide to getting started with Jekyll.
baseurl: ''
url: 'http://localhost:4000'
twitter_username: isfaaghyth
github_username: isfaaghyth
# Build Settings
sass:
  sass_dir: _sass
include: ['_pages']
...
```html
<footer>
	<p>By <a href="http://isfaa.js.org">isfaaghyth</p>
</footer>
```
...
Create an empty repository in GitHub. Mine is **startjekyll**, so the Git repo URL is `https://github.com/isfaaghyth/startjekyll`.
...
```yaml
baseurl: "/startjekyll"
url: "https://isfaaghyth.github.io"
```
...
```bash
git remote add origin https://github.com/isfaaghyth/startjekyll.git
```
...
At this point, you should be able to open up [isfaaghyth.github.io/startjekyll](http://isfaaghyth.github.io/startjekyll), and it should be your Jekyll project! Without using any external task runners (like Grunt or Gulp), you can now work on the Sass files on your website, and serve up markdown files in place of HTML.
