...
> If you just want some hints on how to make your design look pretty or consistent, check out [Design for Developers](https://www.isfaa.js.org/design-for-developers/). I also think [Web Design in 4 Minutes](https://jgthms.com/web-design-in-4-minutes/) by [Jeremy Thomas](https://jgthms.com/) has an excellent, interactive introduction to the concepts of web design.
...
- **Value** - value applied to an attribute (_example:_ `http://isfaaghyth.dev`)
...
```html
<a href="http://isfaaghyth.dev">isfaaghyth's WebRing</a>
```
...
| Value     | `http://isfaaghyth.dev`, `avatar.png`, `Some alt text` |
...
To use a real example, in [this example MVC todo app](https://isfaaghyth.github.io/mvc/) I made, each todo item is padded, and they're separated from each other by margins.
...
This [card element](https://isfaaghyth.github.io/card/) is an example of absolute coming in handy to make sure they're always the same size but the buttons line up.
...
To get an idea of how I generally like to style my CSS, take a look at [Primitive CSS](https://isfaaghyth.github.io/primitive/), the CSS/Sass framework I designed a few years ago, which contains a clean Sass setup and sensible defaults. Creating your own CSS framework and grid is a fun, challenging way to really learn CSS, and I highly recommend it!
