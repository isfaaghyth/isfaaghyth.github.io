...
From this point, you'll have to navigate to the folder in which you keep your web projects. For me, that's **/Users/isfaaghyth/sites**. Since I start off in Terminal at `/Users/isfaaghyth`, I'll move to `sites`.
...
If you would like to play around with a real life example of the exact Gulp workflow from this tutorial, feel free to check out [my personal Sass boilerplate](http://isfaaghyth.github.io/primitive/). [The code is open sourced here](https://github.com/isfaaghyth/primitive), though I have yet to complete documentation.
...
```
git clone https://github.com/isfaaghyth/primitive.git
```
