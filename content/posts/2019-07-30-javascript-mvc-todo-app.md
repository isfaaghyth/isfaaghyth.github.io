...
I made [this todo app](https://isfaaghyth.github.io/mvc), which is a simple little browser app that allows you to CRUD (create, read, update, and delete) todos. It just consists of an `index.html`, `style.css`, and `script.js`, so nice and simple and dependency/framework-free for learning purposes.

#### Prerequisites

- Basic JavaScript and HTML
- Familiarity with [the latest JavaScript syntax](https://www.isfaa.js.org/es6-syntax-and-feature-overview/)
...
- [View demo](https://isfaaghyth.github.io/mvc)
- [View source](https://github.com/isfaaghyth/mvc)
...
I wrote a small bit of CSS just to make it look acceptable, which you can find [here](https://github.com/isfaaghyth/mvc/blob/master/style.css) and save to `style.css`. I'm not going to write any more about the CSS, because it's not the focus of this article.
