...
- [View Demo](https://isfaaghyth.github.io/sandbox/tab/)
- [View Source](https://github.com/isfaaghyth/sandbox/tree/master/tab)
...
- Create a "new tab page" application that stores to-do items locally in the browser's [local storage](https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage) and displays them on the front end. [View example](https://isfaaghyth.github.io/sandbox/tab/).
...
First, we'll create a simple HTML front end with **index.html**. I'm loading in [Primitive](https://isfaaghyth.github.io/primitive/) (my minimalist CSS framework) for styles, because that's what I always use when I need a quick front end.
