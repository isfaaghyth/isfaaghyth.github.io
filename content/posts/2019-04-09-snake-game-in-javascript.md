...
I thought writing the classic Snake game would be a fun and easy project to get used to blessed, so I wrote [🐍 Snek.js](https://github.com/isfaaghyth/snek).

You can [check out the source](https://github.com/isfaaghyth/snek), or download it and play it yourself:

```bash
git clone https://github.com/isfaaghyth/snek
cd snek
...
Again, you can view the source on GitHub at [🐍 Snek.js](https://github.com/isfaaghyth/snek).
