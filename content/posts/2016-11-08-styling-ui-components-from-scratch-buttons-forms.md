...
To make life easy for myself, I've compiled all these into my own framework, [Primitive](http://isfaaghyth.github.io/primitive/) (which also incorporates Sass and Gulp) and I encourage you to make your own as well, even if only for learning purposes.
