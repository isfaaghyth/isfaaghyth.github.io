...
Go to your local directory. Mine is `Users/isfaaghyth/sites/startgrunt`. Here's the Terminal command I'll use to move to that directory.
...
"repository": {
    "type": "git",
    "url": "https://github.com/isfaaghyth/startgrunt.git"
}
```
...
I've [set up a GitHub repository](https://github.com/isfaaghyth/startgrunt) of the project for you to play with.

- [View source on GitHub](https://github.com/isfaaghyth/startgrunt)
