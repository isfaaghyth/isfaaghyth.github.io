...
Here's the final map project that I created: [Cafétography](https://isfaaghyth.github.io/coffee/)
...
Here is an [example project on CodePen](https://codepen.io/isfaaghyth/pen/brRaVE) you can use. All it requires is an html file (**index.html**) with the prerequisite CSS and JavaScript Leaflet files loading in:
...
Again, you can find and fork a working version of the whole thing [right here](https://codepen.io/isfaaghyth/pen/brRaVE) on CodePen, but you'll have to transfer it to your own server or work on it locally.
