...
> Want to use the Flexbox layout model instead of a CSS float grid? [Here is a tutorial](http://www.isfaa.js.org/easiest-flex-grid-ever/) on how to make the same grid in Flexbox.

See the Pen [CSS Float Grid](http://codepen.io/isfaaghyth/pen/GpGdyy/)
...
Earlier, I wrote an article [on how to make a responsive dropdown navigation bar](http://www.isfaa.js.org/responsive-dropdown-navigation-bar/) from scratch. If you want a complete understanding of how it works from start to finish, I would recommend reading that article.

See the Pen [Responsive Dropdown Navigation Bar](http://codepen.io/isfaaghyth/pen/dYvvYv/)

I have also created a simplified version without dropdowns and written in vanilla CSS. [Click here to view the simplified pen](http://codepen.io/isfaaghyth/pen/epKrPm).
