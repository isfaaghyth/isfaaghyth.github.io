...
- [View Demo App](https://isfaaghyth.github.io/sandbox/ghibli/)
- [Source Code on GitHub](https://github.com/isfaaghyth/sandbox/tree/master/ghibli)
...
An empty `img` is no good, so we'll set the `src` attribute to `logo.png`. (Found [here](https://github.com/isfaaghyth/sandbox/blob/master/ghibli/logo.png))
