...
In part one of the tutorial series [Developing a WordPress Theme From Scratch](http://www.isfaa.js.org/developing-a-wordpress-theme-from-scratch/), we learned what WordPress is, what it can do, and how to do the following:
...
- Ability set up WordPress and make a basic theme ([covered in part one](http://www.isfaa.js.org/developing-a-wordpress-theme-from-scratch/))
...
> I have a [README on GitHub of useful WordPress functions](https://github.com/isfaaghyth/wp-functions), which might come in handy the more you use them.
...
All the source code is [on GitHub](https://github.com/isfaaghyth/startwordpress) as always. You can download the code and upload it into your themes folder and see it in action. I might set up a demo if there's any interest in that.
...
[View on GitHub](https://github.com/isfaaghyth/startwordpress)
