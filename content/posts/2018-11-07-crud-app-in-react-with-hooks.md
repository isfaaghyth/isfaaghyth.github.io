...
- [View Demo App](https://isfaaghyth.github.io/react-hooks/)
- [View Source](https://github.com/isfaaghyth/react-hooks)
...
In this tutorial, we'll make a [simple CRUD app](https://isfaaghyth.github.io/react-hooks/). It will have users, and you'll be able to add, update, or delete users. We won't use any React classes, and instead we'll utilize State Hooks and Effect Hooks on functional components. If you get lost along the way, be sure to check out [the source of the completed project](https://github.com/isfaaghyth/react-hooks).
...
For `index.css`, I just copy and paste the CSS from [Primitive](https://isfaaghyth.github.io/primitive/css/main.css), a simple CSS boilerplate I made, as the point of this app is to work on React and not care about design. This CSS boilerplate just adds some sensible defaults and a simple grid so we can start prototyping.
...
const App = () => {
  const usersData = [
    { id: 1, name: 'isfaaghyth', username: 'floppydiskette' },
