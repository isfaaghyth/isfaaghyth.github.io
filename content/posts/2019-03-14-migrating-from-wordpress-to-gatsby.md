...
On September 24th, 2015, I made the [first post](/getting-started-with-git) on this blog, which was a custom self-hosted WordPress theme. I discovered Git, I discovered WordPress, and I [made 1,039 commits](https://github.com/isfaaghyth/oblate), in which I obsessively [designed](https://www.isfaa.js.org/version-2-0-website-redesign-863-commits-later) and [redesigned](https://www.isfaa.js.org/website-redesign-version-4-0) the site.
...
- I basically had to re-do all the styles, using [Primitive](https://isfaaghyth.github.io/primitive) as the base of the style system as I haven't caught on to the idea of using CSS-in-JS yet.
