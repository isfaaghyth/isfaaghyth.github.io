...
See the Pen [mEerjX](http://codepen.io/isfaaghyth/pen/mEerjX/)
...
See the Pen [Prism Syntax Highlighting](http://codepen.io/isfaaghyth/pen/wWKzQQ/)

Now you override the styles with whatever you want in the CSS file. On this blog, I use [New Moon](http://isfaaghyth.github.io/new-moon/), my own personal coding theme that I made available as an open-source package on Brackets, Atom, and Sublime because I'm that much of a dork. I encourage you to make your own as well.
