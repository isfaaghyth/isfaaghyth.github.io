...
Recently, I wrote a lot of tests for [a project I've been working on](https://github.com/isfaaghyth/chip8), and after all that work I wanted to put some nice badges on my repo.

I have one badge displaying that my build has passed (hopefully), and another displaying my code coverage percent.

![](../images/cov.png)

> I'll use my account ([isfaaghyth](https://github.com/isfaaghyth/)) and my project's repo ([chip8](https://github.com/isfaaghyth/chip8)) as examples for the name. I'm assuming you're using GitHub, but it also applied to GitLab or BitBucket.
...
The page-specific URL should be https://travis-ci.org/isfaaghyth/chip8.
...
The page-specific URL should be https://coveralls.io/github/isfaaghyth/chip8.
...
```md
[![Build Status](https://travis-ci.org/<your-account>/<your-repo>.svg?branch=master)](https://travis-ci.org/isfaaghyth/chip8)
```

<div class="filename">Code Coverage Badge</div>

```md
[![Coverage Status](https://coveralls.io/repos/github/<your-account>/<your-repo>/badge.svg?branch=master)](https://coveralls.io/github/isfaaghyth/chip8?branch=master)
```
