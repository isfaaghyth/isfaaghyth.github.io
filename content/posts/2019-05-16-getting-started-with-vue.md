...
- [View demo](https://isfaaghyth.github.io/vue-tutorial/)
- [View source](https://github.com/isfaaghyth/vue-tutorial)
...
As always, this tutorial is about functionality, not styles, so I'm just going to link to [Primitive UI](https://github.com/isfaaghyth/primitive) in the `index.html` file to add some easy default styles.
...
> Our `EmployeeForm` file is complete, and you can [view the source](https://github.com/isfaaghyth/vue-tutorial/blob/master/src/components/EmployeeForm.vue) of the completed file in case you got lost along the way.
...
And the app is complete! You can [check out the live demo](https://isfaaghyth.github.io/vue-tutorial/) or [view the source](https://github.com/isfaaghyth/vue-tutorial).
