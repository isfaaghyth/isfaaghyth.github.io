        ...
        <div className="container note-container">
          <div className="flex-author">
            <div className="flex-avatar">
              <img className="avatar" src={tania} alt="Muh Isfhani Ghiath" />
            </div>
            <div>
              <h3>Author</h3>
              <p>
                Hey, I’m isfaaghyth, a full stack software engineer. I write about what I know to help
              ...
              <div className="flex">
                <a
                  href="https://ko-fi.com/isfaaghyth"
                ...
                <a
                  ...
                  href="https://www.patreon.com/isfaaghyth"
                  target="_blank"
                  rel="noopener noreferrer"
                >
